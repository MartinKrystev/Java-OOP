...
public abstract class BaseArea implements Area {
    ...
    public String getInfo() {
        ...
        sb.append(name).append(" (").append(getClass().getSimpleName()).append("):").append(System.lineSeparator());
        sb.append("Animals: ").append(animals.size() == 0 ? "none" : animals.stream().map(a -> a.getName()).collect(Collectors.joining(" "))).append(System.lineSeparator());
