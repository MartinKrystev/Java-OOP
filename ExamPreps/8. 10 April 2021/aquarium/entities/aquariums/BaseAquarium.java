...
public abstract class BaseAquarium implements Aquarium {
    ...
    public String getInfo() {
        String fishOrNone = this.fish.isEmpty()
                ? "none"
        ...
        sb.append(String.format("Fish: %s", fishOrNone)).append(System.lineSeparator());
        sb.append(String.format("Decorations: %s",this.decorations.size())).append(System.lineSeparator());
